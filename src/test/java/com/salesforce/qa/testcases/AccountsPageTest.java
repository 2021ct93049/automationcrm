...
/*
 * TC_01 This Test case is developed to create Account in Salesforce application by providing all mandatory details
 */
...
public class AccountsPageTest extends TestBase {
	...
	public void createAccount() throws Exception{
		try {
			...
			System.out.println("Test Script Started with Account creation");
			...
			screenShotMsg(accountName+" Account Created suceesfully");
			...
			accountsPage.saveBtn();
			screenShotMsg(accountName+" edited details Saved");
