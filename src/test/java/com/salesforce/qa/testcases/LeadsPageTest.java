...
/*
 * TC_03 This Test case is developed to create Leads in Salesforce application by providing all mandatory details
 */
public class LeadsPageTest extends TestBase {
	...
	/*
	 * createLead method is to create Leads in Salesforce application
	 */
	...
	public void createLead() throws Exception{
		try {
			...
			System.out.println("Test Script Started with Leads creation");
